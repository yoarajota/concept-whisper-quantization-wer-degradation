...
| :--- | :--- | :--- |
| **TRL** | **1** | Basic principles observed (`framework/instruments/trl.md`) |
| **SRL**  | **2** | A materiel solution should have been considered — seams only (`framework/instruments/srl.md` FD-005) |
| Composite SRL | 0.111 | standard formulation (all components, diagonal-inclusive) |
| Weakest component | core (0.1111) | lowest component-level SRL |
| Weakest seam | n/a | lowest-scoring integration pair |
| Phase | P1 | `framework/10-lifecycle.md` |
| Hypothesis | untested, untested | |
| Suitable for | not assessed | `framework/instruments/diffusion.md` |

| Component | Role | TRL | Component SRL |
| :--- | :--- | :-: | :-: |
| `core` | concept | 1 | 0.111 |
