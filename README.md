...
| **SRL**  | **3** | High-risk immature technologies identified and prototyped — seams only (`framework/instruments/srl.md` FD-005) |
| Composite SRL | 0.630 | standard formulation (all components, diagonal-inclusive) |
...
| Phase | P4 | `framework/10-lifecycle.md` |
