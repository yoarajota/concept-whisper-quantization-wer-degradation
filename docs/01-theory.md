...
**H-001** — Under TODO conditions, Whisper quantization WER degradation curve achieves TODO metric TODO comparison against
...
<!-- Anything the literature does not settle, and anything a source could not be verified for.
     Unverifiable claims go here as questions, never into the sections above (rule R7). -->
